...
## [Exercise 3.6](3.06.cpp)
Use a range for to change all the characters in a string to X.
## [Exercise 3.7](3.07.cpp)
...
## [Exercise 3.9](3.09.txt)
What does the following program do? Is it valid? If not, why not?
```
string s;
cout << s[0] << endl;
```
## [Exercise 3.10](3.10.cpp)
...
## [Exercise 3.18](3.18.txt)
Is the following program legal? If not, how might you fix it?
```
vector<int> ivec;
ivec[0] = 42;
```
## [Exercise 3.19](3.19.cpp)
...
## [Exercise 3.21](3.21.cpp)
Redo the first exercise from § 3.3.3 (p. 105) using iterators.
## [Exercise 3.22](3.22.cpp)
...
```
## [Exercise 3.29](3.29.txt)
List some of the drawbacks of using an array instead of a vector.
## [Exercise 3.30](3.30.txt)
