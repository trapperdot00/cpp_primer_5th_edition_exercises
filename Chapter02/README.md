...
(d) 10, 10u, 10., 10e-2
```
## [Exercise 2.6](2.06.txt)
What, if any, are the differences between the following definitions:
```
int month = 9, day = 7;
int month = 09, day = 07;
```
## [Exercise 2.7](2.07.txt)
...
p2 = p3;
```
## [Exercise 2.32](2.32.cpp)
Is the following code legal or not? If not, how might you make it legal?
```
int null = 0, *p = null;
```
## [Exercise 2.33](2.33.txt)
...
```
## [Exercise 2.40](2.40.cpp)
Write your own version of the Sales_data class.
## [Exercise 2.41](2.41.cpp)
