...
class Sales_data {
	...
	friend std::vector<Sales_data>::iterator first_greater(std::vector<Sales_data> &, double);
	friend std::vector<Sales_data>::const_iterator first_greater(const std::vector<Sales_data> &, double);
public:
	...
	static const std::string Sales_data::*bookNo_pointer() { return &Sales_data::bookNo; }
private:
