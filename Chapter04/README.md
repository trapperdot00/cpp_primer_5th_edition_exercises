...
## [Exercise 4.1](4.01.txt)
What is the value returned by 5 + 10 * 20/2?
## [Exercise 4.2](4.02.txt)
...
## [Exercise 4.12](4.12.txt)
Assuming i, j, and k are all ints, explain what i != j < k means.
## [Exercise 4.13](4.13.txt)
...
(b) i = d = 3.5;
```
## [Exercise 4.14](4.14.txt)
Explain what happens in each of the if tests:
```
if (42 = i) // ...
if (i = 42) // ...
```
## [Exercise 4.15](4.15.txt)
The following assignment is illegal. Why? How would you correct it?
```
double dval; int ival; int *pi;
dval = ival = pi = 0;
```
## [Exercise 4.16](4.16.txt)
...
(b) if (i = 1024)
```
## [Exercise 4.17](4.17.txt)
Explain the difference between prefix and postfix increment.
## [Exercise 4.18](4.18.txt)
...
(d) ul1 || ul2
```
## [Exercise 4.28](4.28.cpp)
Write a program to print the size of each of the built-in types.
## [Exercise 4.29](4.29.cpp)
